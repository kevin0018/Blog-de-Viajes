<template>
  <header class="relative bg-cover bg-center h-[50vh] shadow-lg" style="background-image: url('/assets/images/header-bg.jpg');">
    ...
    <div class="relative z-10 flex flex-col items-center h-full">
      ...
      <nav class="absolute top-0 left-0 w-full flex justify-between items-center px-8 lg:px-16 py-4 text-white lg:text-xl font-medium">
        ...
        <!-- Logo centrado -->
        <a href="/" class="absolute left-1/2 transform -translate-x-1/2 top-4 lg:top-1/2 lg:-translate-y-1/2">
          <img
